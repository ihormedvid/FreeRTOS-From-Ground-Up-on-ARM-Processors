...
int main(void)
{
  ...
  printf("System initialized properly...\n\r");
  ...
  xTaskCreate(vReceiverTask, "Receiver Task", 200, NULL, 2, NULL);
...
void vSenderTask1(void *pvParams)
{
	...
	char *msg = "Welcome from Sender1 Task\r\n";
...
{
	const TickType_t xBlockTime = pdMS_TO_TICKS(200);
	char *msg = "Welcome from Sender1 Task2\r\n";
...
void vReceiverTask(void *pvParams)
{
    ...
    while(1)
    {
    	// This value represents the longest possible delay
